...
class GroupApi
{
     ...
     */
    public function createGroup($create_group_request = null)
    {
        list($response) = $this->createGroupWithHttpInfo($create_group_request);
        return $response;
    }
     ...
     */
    public function createGroupWithHttpInfo($create_group_request = null)
    {
     ...
     */
    public function createGroupAsync($create_group_request = null)
    {
        return $this->createGroupAsyncWithHttpInfo($create_group_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function createGroupRequest($create_group_request = null)
    {
        ...
        if (isset($create_group_request)) {
            $_tempBody = $create_group_request;
        }
     ...
     * List Groups
     *
     * @param  string $when The date to retrieve albums for. (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetGroupsResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetGroupsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listGroupsWithHttpInfo($when = null)
    {
        $request = $this->listGroupsRequest($when);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetGroupsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listGroupsAsync($when = null)
    {
        return $this->listGroupsAsyncWithHttpInfo($when)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listGroupsAsyncWithHttpInfo($when = null)
    {
        $returnType = '\OpenAPI\Client\Model\GetGroupsResponse';
        $request = $this->listGroupsRequest($when);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listGroupsRequest($when = null)
    {
        ...
        // query params
        if ($when !== null) {
            $queryParams['when'] = ObjectSerializer::toQueryValue($when);
        }
    ...
    /**
     * Operation searchForGroupByToken
     *
     * Search for Group by Token
     *
     * @param   $UNKNOWN_PARAMETER_NAME The Token to look for. (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetGroupsResponse
     */
    public function searchForGroupByToken($UNKNOWN_PARAMETER_NAME)
    {
        list($response) = $this->searchForGroupByTokenWithHttpInfo($UNKNOWN_PARAMETER_NAME);
        return $response;
    }

    /**
     * Operation searchForGroupByTokenWithHttpInfo
     *
     * Search for Group by Token
     *
     * @param   $UNKNOWN_PARAMETER_NAME The Token to look for. (required)
     ...
     * @return array of \OpenAPI\Client\Model\GetGroupsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchForGroupByTokenWithHttpInfo($UNKNOWN_PARAMETER_NAME)
    {
        $request = $this->searchForGroupByTokenRequest($UNKNOWN_PARAMETER_NAME);
    ...
    /**
     * Operation searchForGroupByTokenAsync
     *
     * Search for Group by Token
     *
     * @param   $UNKNOWN_PARAMETER_NAME The Token to look for. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchForGroupByTokenAsync($UNKNOWN_PARAMETER_NAME)
    {
        return $this->searchForGroupByTokenAsyncWithHttpInfo($UNKNOWN_PARAMETER_NAME)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation searchForGroupByTokenAsyncWithHttpInfo
     *
     * Search for Group by Token
     *
     * @param   $UNKNOWN_PARAMETER_NAME The Token to look for. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchForGroupByTokenAsyncWithHttpInfo($UNKNOWN_PARAMETER_NAME)
    {
        $returnType = '\OpenAPI\Client\Model\GetGroupsResponse';
        $request = $this->searchForGroupByTokenRequest($UNKNOWN_PARAMETER_NAME);
    ...
    /**
     * Create request for operation 'searchForGroupByToken'
     *
     * @param   $UNKNOWN_PARAMETER_NAME The Token to look for. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchForGroupByTokenRequest($UNKNOWN_PARAMETER_NAME)
    {
        ...
        if ($UNKNOWN_PARAMETER_NAME === null || (is_array($UNKNOWN_PARAMETER_NAME) && count($UNKNOWN_PARAMETER_NAME) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $UNKNOWN_PARAMETER_NAME when calling searchForGroupByToken'
            );
        }

        $resourcePath = '/Group/Search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($UNKNOWN_PARAMETER_NAME !== null) {
            $queryParams['q'] = ObjectSerializer::toQueryValue($UNKNOWN_PARAMETER_NAME);
        }
     ...
     *
     * @param  string $group_id The UUID of the Group (required)
     * @param  \OpenAPI\Client\Model\UpdateGroupRequest $update_group_request update_group_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\UpdateGroupResponse
     */
    public function updateGroup($group_id, $update_group_request)
    {
        list($response) = $this->updateGroupWithHttpInfo($group_id, $update_group_request);
        return $response;
    }
     ...
     *
     * @param  string $group_id The UUID of the Group (required)
     * @param  \OpenAPI\Client\Model\UpdateGroupRequest $update_group_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\UpdateGroupResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateGroupWithHttpInfo($group_id, $update_group_request)
    {
        $request = $this->updateGroupRequest($group_id, $update_group_request);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\UpdateGroupResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\UpdateGroupResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\UpdateGroupResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\UpdateGroupResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateGroupAsync($group_id, $update_group_request)
    {
        return $this->updateGroupAsyncWithHttpInfo($group_id, $update_group_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateGroupAsyncWithHttpInfo($group_id, $update_group_request)
    {
        $returnType = '\OpenAPI\Client\Model\UpdateGroupResponse';
        $request = $this->updateGroupRequest($group_id, $update_group_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateGroupRequest($group_id, $update_group_request)
    {
        // verify the required parameter 'group_id' is set
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($update_group_request)) {
            $_tempBody = $update_group_request;
        }
