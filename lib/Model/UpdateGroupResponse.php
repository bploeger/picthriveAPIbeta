...
/**
 * UpdateGroupResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class UpdateGroupResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets time_of_tour
     *
     * @param int|null $time_of_tour The Unix timestamp that we guess this album was created for. Returned if the Album Name changes and we extracted a new time from it.
     *
     * @return $this
     */
     ...
     * Sets formatted_time
     *
     * @param string|null $formatted_time A string representation of the time we guess this album was created for. Returned if the Album Name changes and we extracted a new time from it.
     *
     * @return $this
     */
